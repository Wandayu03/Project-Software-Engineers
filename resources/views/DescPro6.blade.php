...
<body>
    ...
    <section id="details" class="section-p1">
        <div class="big-image">
            <img class="des1" src="{{ asset('assets/images/pupuk.png') }}" id="MainImage" alt="" width="600px" >
        </div>
        <div class="small-details">
            <h6>Home / Products</h6>
            <h4>Pupuk pak tani</h4>
            <h2>Rp 70.000</h2>
            ...
            <span>
                merupakan media tanam siap pakai cocok untuk semua tanaman. karena komposisi yang terbaik untuk tanaman.
                Manfaat :
                Menyuburkan Tanaman‼️
                Menstabilkan Ekosistem‼️
            </span>
        </div> 
    </section>
