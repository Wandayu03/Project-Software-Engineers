...
<body>
    ...
    <section id="details" class="section-p1">
        <div class="big-image">
            <img class="des1" src="{{ asset('assets/images/rotan.png') }}" id="MainImage" alt="" width="700px" >
        </div>
        <div class="small-details">
            ...
            <span>Kursi terbuat dari rotan kulit dan dianyam dengan Rotan Lesio asli, telah melalui tahap finishing melamin terbaik.
                Sehingga menjamin ketahanan dan perawatan cukup mudah, bisa digunakan di indoor maupun outdoor. 
                Sangat cocok digunakan untuk gaya hunian kontemporer seperti di cafe.
                Sangat cocok untuk kursi teras depan rumah, kursi santai, kursi tv, kursi tamu.
                Dengan bentuk unik dan minimalis, tidak banyak memakan tempat sehingga ruangan nampak terlihat lebih luas. 
            </span>
        </div> 
    </section>
