...
<body>
    ...
    <section id="details" class="section-p1">
        <div class="big-image">
            <img class="des1" src="{{ asset('assets/images/sofa.png') }}" id="MainImage" alt="" width="600px" >
        </div>
        <div class="small-details">
            ...
            <span>
                minus noda pemakaian dan ada sobek sedikit dibagian atas. 3 seater,
                Warna abu-abu, Kondisi 90% bagus jarang dipakai duduk, Harga beli 3jt, Merk nya lupa namanya, Beli tahun 2017, Alasan jual karena mau ganti, ongkir 300rb jabodetabek
