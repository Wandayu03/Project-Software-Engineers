...
<body>
    ...
    <section id="details" class="section-p1">
        <div class="big-image">
            <img class="des1" src="{{ asset('assets/images/pot.png') }}" id="MainImage" alt="" width="600px" >
        </div>
        <div class="small-details">
            ...
            <span>
                Pot Bunga Besar. Pot Taanaman Plastik Hitam Ukuran 35cm,Warna : Putih, Diameter Atas : 34cm,
                Diameter Bawah: 19cm, Tinggi : 25cm, Berat : 390gr - 400gr (Besar, Sangat Tebal & Sangat Kuat),
                100% Original,Berkualitas Dan Paling Murah.
            </span>
        </div> 
    </section>
