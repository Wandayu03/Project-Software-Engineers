...
<body>
    ...
    <section id="details" class="section-p1">
        <div class="big-image">
            <img class="des1" src="{{ asset('assets/images/sepatu.png') }}" id="MainImage" alt="" width="600px" >
        </div>
        <div class="small-details">
            ...
            <span>
                Sepatu kami benar-benar REAL PICT menggunakan kamera handphone sehingga barang yang dikirim akan sesuai dengan foto dan deskripsi,
Garansi 100% return / refound jika barang yang dikirim tidak sesuai dengan foto dan deskripsi
NOTE : mohon tanyakan ketersediaan prodak terlebih dulu sebelum order
